...
{
    private static final long serialVersionUID = -8511033917003650350L;
    private RankedStandaloneProgramme[] content;
    ...
    public RankedStandaloneProgramme[] getContent() {
        return this.content;
    }
    
    public void setContent(final RankedStandaloneProgramme[] content) {
